    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          {/* Right — showcase card, positioned at far right edge */}
          <div className="hero-right-card hidden lg:flex flex-col w-[300px] shrink-0 mr-0 xl:-mr-4">
            <div className="glass border border-white/10 p-6 space-y-5">
              {/* Logo mark */}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] text-muted">Available for work</span>
              </div>

              {/* Tech stack */}
              <div>
                <div className="text-[9px] uppercase tracking-[0.2em] text-crimson mb-2.5">Core Stack</div>
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div>
                  <div className="font-display text-base text-ink">14<span className="text-crimson">+</span></div>
                  <div className="text-[8px] uppercase tracking-widest text-muted">Projects</div>
                </div>
                <div>
                  <div className="font-display text-base text-ink">22<span className="text-crimson">+</span></div>
                  <div className="text-[8px] uppercase tracking-widest text-muted">Technologies</div>
                </div>
                <div>
                  <div className="font-display text-base text-ink">2026</div>
